...
I no longer use Ubuntu for this. I have switched over to [NixOS in WSL](https://github.com/19stephan93/homelab-nixos-wsl), which is much easier to create repeatable builds after you've worked through the configuration hurdles.
...
Install tools as per [Omni installation instructions](https://github.com/19stephan93/homelab-omni)
